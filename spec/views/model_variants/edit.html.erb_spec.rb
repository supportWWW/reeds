...
describe "/model_variants/edit.html.erb" do
  ...
  it "should render edit form" do
    render "/model_variants/edit.html.erb"
    
    response.should have_tag("form[action=#{model_variant_path(@model_variant)}][method=post]") do
