...
describe "/classifieds/index.html.erb" do
  ...
  before(:each) do
    ...
    classified_98.should_receive(:year).and_return("1")
    classified_98.should_receive(:price_in_cents).and_return("1")
    ...
    classified_99.should_receive(:year).and_return("1")
    classified_99.should_receive(:price_in_cents).and_return("1")
