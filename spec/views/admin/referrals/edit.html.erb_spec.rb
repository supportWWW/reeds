...
describe "/admin/referrals/edit.html.erb" do
  ...
  it "should render edit form" do
    render "/admin/referrals/edit.html.erb"
    
    response.should have_tag("form[action=#{admin_referral_path(@referral)}][method=post]") do
