...
describe "/admin/new_vehicles/edit.html.erb" do
  ...
  it "should render edit form" do
    render "/admin/new_vehicles/edit.html.erb"
    
    response.should have_tag("form[action=#{admin_new_vehicle_path(@new_vehicle)}][method=post]") do
