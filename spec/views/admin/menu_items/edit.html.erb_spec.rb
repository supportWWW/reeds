...
describe "/admin/menu_items/edit.html.erb" do
  ...
  it "should render edit form" do
    render "/admin/menu_items/edit.html.erb"
    
    response.should have_tag("form[action=#{admin_menu_item_path(@menu_item)}][method=post]") do
